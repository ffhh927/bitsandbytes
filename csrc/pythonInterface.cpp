...
{	optimizerStatic8bitBlockwise<gtype, optim_name>(p, g, state1, state2, state3, beta1, beta2, eps, step, lr, quantiles1, quantiles2, quantiles3, absmax1, absmax2, absmax3, weight_decay, \
	gnorm_scale, skip_zeros, n, kl_clip, is_kl_clip, ma_len, mg_len); }\
...
MAKE_BLOCKWISE8(eva, EVA, half, fp16)
MAKE_BLOCKWISE8(eva, EVA, float, fp32)
MAKE_BLOCKWISE8(eva, EVA, __nv_bfloat16, bf16)
...
extern "C"
{
  ...
  void c##fname##_8bit_blockwise_grad_##gbits(gtype* p, gtype* g, \
                ...
                float* quantiles1, float* quantiles2, float* quantiles3, float* absmax1, float* absmax2,  float* absmax3, float weight_decay, const float gnorm_scale, bool skip_zeros, int n, \
                const float kl_clip, const bool is_kl_clip, const int ma_len, const int mg_len)\
  {	fname##_8bit_blockwise_grad_##gbits(p, g, state1, state2, state3, beta1, beta2, eps, step, lr, quantiles1, quantiles2, quantiles3, absmax1, absmax2, absmax3, weight_decay, \
	gnorm_scale, skip_zeros, n, kl_clip, is_kl_clip, ma_len, mg_len); } \
	...
	MAKE_CBLOCKWISE8(eva, EVA, half, fp16)
	MAKE_CBLOCKWISE8(eva, EVA, float, fp32)
	MAKE_CBLOCKWISE8(eva, EVA, __nv_bfloat16, bf16)
